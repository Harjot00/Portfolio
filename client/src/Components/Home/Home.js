...
function Home() {
  ...
  return (
    <div
      className="grid grid-cols-4 md:gap-y-12 mx-auto lg:mx-12 items-center lg:my-16 lg:py-16 snap-start"
      id="home"
    >
      ...
      <div className="md:col-span-3 lg:col-span-2 ">
        <div>
          <div className="flex space-x-4">
            <p className=" md:text-4xl lg:text-5xl font-bold tracking-widest">
              Harjot Singh
            </p>
            <svg
              width="36"
          ...
          <div className="w-full md:flex items-center md:space-x-4 mt-8 mb-4">
            <div className="hidden md:block md:w-[125px] lg:w-[150px] border-b-2 border-black"></div>
            <p className=" text-xl lg:text-2xl"> Full Stack developer</p>
          </div>
          <div>
            <p className="w-[200px] md:w-[400px] ">
              I'm a mern stack developer based in GTA, Ontario with a focus on
              building efficient web applications.And highly skilled in MongoDB,
              Express, React, and Node.js.
            </p>
          </div>
          <button className="w-[125px] bg-gray-800 text-white text-lg font-md text-md py-3 rounded-2xl my-8 hover:scale-110 ease-in-out  duration-200">
            Say Hello
          </button>
        </div>
      </div>
      <div className="col-span-4 lg:col-span-1 md:flex justify-between">
        <div
          className="lg:hidden flex items-center space-x-2 justify-center mb-4 md:mb-0"
          onClick={scrollDown}
        >
          <p>Scroll down</p>
          <AiOutlineArrowDown />
        ...
        <div>
          <img
            className="w-full md:w-[350px] lg:w-[500px] rounded-full aspect-square object-cover grayscale brightness-200 relative -z-10"
            src="https://images.unsplash.com/photo-1624377632657-3902bfd35958?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxzZWFyY2h8NzV8fGRldmVsb3BlcnxlbnwwfHwwfHw%3D&auto=format&fit=crop&w=500&q=60"
            alt="my-profile-pic"
          />
        </div>
      </div>
      <div className="hidden  col-span-1 my-16 lg:flex items-center mx-auto space-x-2 cursor-pointer">
        <p>Scroll down</p>
        <AiOutlineArrowDown />
      </div>
    </div>
